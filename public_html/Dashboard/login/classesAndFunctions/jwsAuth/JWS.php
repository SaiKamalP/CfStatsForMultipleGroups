...
require_once __DIR__."/Algorithm/AlgorithmInterface.php";
require_once __DIR__."/Algorithm/HMACAlgorithm.php";
require_once __DIR__."/Algorithm/RSA_SSA_PKCSv15.php";

require_once __DIR__."/Exception/InvalidSignatureException.php";
require_once __DIR__."/Exception/MalformedSignatureException.php";
require_once __DIR__."/Exception/UnexpectedAlgorithmException.php";
require_once __DIR__."/Exception/UnspecifiedAlgorithmException.php";
require_once __DIR__."/Exception/UnsupportedAlgorithmException.php";

require_once __DIR__."/Util/Base64Url.php";
